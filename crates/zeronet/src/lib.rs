...
pub use peer::{Peer, PeerManager, PeerInfo, PeerStatus};
pub use protocol::{Protocol, ProtocolMessage, BlockMessage, TxMessage};
...
impl NetworkService {
    ...
    pub async fn start(&self) -> Result<()> {
        ...
        tracing::info!("Starting network service on port {}", self.config.listen_port);
